<template>
  <div class="max-w-[20rem] rounded overflow-hidden shadow-[0_0px_3px_1.5px_rgba(0,0,0,0.2)]">
    ...
    <div class="px-5 pb-2 pt-3">
      ...
      <div 
        class="select-none text-gray-700 text-[0.9rem] md:text-[0.95rem] overflow-y-scroll border-[0.3rem] border-r-[0rem] border-[#cac8c5] md:leading-[1.37rem] px-2 py-1 text-justify" 
