<template>
  <div class="max-w-3xl mx-auto p-3 mt-4 2xl:text-[1.08rem] 2xl:max-w-[53rem] 2xl:mb-4">
    ...
    <ul class="list-decimal pl-4">
      <li class="mt-1"><strong><a href="https://github.com/Habbatul/WhatsappExportViewer" target="_blank" class="underline underline-offset-4 hover:text-red-600">Whatsapp Log Viewer</a> :</strong> Whatsapp Export Viewer. Reader app for whatsapp export chat .txt. This app is installable on your phone (PWA).</li>
      ...
      <li class="mt-1"><strong><a href="https://github.com/Habbatul/JavaFX-ArcadeGames" target="_blank" class="underline underline-offset-4 hover:text-red-600">JavaFx Arcade Games</a> :</strong> Arcade games made with JavaFX, this is the first application I made while in college, there are two games in this .jar application.</li>
      <li class="mt-1"><strong><a href="https://github.com/Habbatul/phpCA-Starter" target="_blank" class="underline underline-offset-4 hover:text-red-600">PHP Clean Architecture Boilerplate</a> :</strong> Template project for clean architecture with PHP.</li>
    </ul>
  </div>
</template>
